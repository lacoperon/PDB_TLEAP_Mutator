def generate_heat_sh(struct_name):
    ...
    # MD sim: Heating
    n78.mpich3.wrapper pmemd.cuda.MPI -O -i heat.in -o {0}_gc_heat.out -p ../TLEAP/{0}_gc_wat.prmtop -c ../EMIN/{1}_GC_min11.rst -r {1}_gc_heat.rst -ref ../EMIN/{1}_GC_min11.rst

    # make pdb snapshot
    /share/apps/CENTOS6/amber/amber16/bin/ambpdb -p ../TLEAP/{0}_gc_wat.prmtop -c {0}_gc_heat.rst > {0}_gc_heat.pdb
